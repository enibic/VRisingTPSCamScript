; ---------------------------------------------------------------------------
; V RISING TPS CAMERA FOLLOW SCRIPT V0.23
; IT'S NOT PERFECT
...
ScriptRunSwitch() {
	...
	;DESACTIVATE SCRIPT
		...
		ToolTip, , , , 2
		ToolTip, , , , 3
		ToolTip, Script OFF, 20, 10, 1
	}
}

ShowTPS() {
	if tpsMode
		ToolTip, TPS ON, 100, 10, 3
	else 
		ToolTip, TPS OFF, 100, 10, 3	
}
...
Msgbox,
(
			    VRISING TPS CAMERA SCRIPT V0.24
